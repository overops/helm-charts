...
$ helm install -n=overops myoverops --set overops.defaultUserPass=[YOUR-PASSWORD] --set overops.defaultUserServiceKey=[YOUR-KEY] ./overops-server
```
...
| `mysql.mysqlUser`                            | Username of new datbase user to create.                                                      | `overops`                                            |
